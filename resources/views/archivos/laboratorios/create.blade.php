		...
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					...
					<span><strong>Agregar Laboratorio</strong></span>
				</div>
				<div class="box-icons">
			...
			<div class="box-content">
				...
				<form class="form-horizontal" role="form" method="post" action="laboratorios/create">
					{{ csrf_field() }}
					<div class="form-group">
						...
						<a href="{{route('laboratorios.index')}}" style="margin-left:15px; margin-top: 20px;" class="col-sm-2 btn btn-danger">Volver</a>
					</div>			
				</form>	
			</div>
		</div>
